...
pateka_pdf_a4 = Path(f"{current_directory}PDF_A4")
pateka_pdf_a3 = Path(f"{current_directory}PDF_A3")
pateka_pdf_a2 = Path(f"{current_directory}PDF_A2")
pateka_pdf_a1 = Path(f"{current_directory}PDF_A1")
pateka_pdf_a0 = Path(f"{current_directory}PDF_A0")
pateka_pdf_print = Path(f"{current_directory}PDF_PRINT")

pateka_pdf_nestandarden_format = Path(f"{current_directory}PDF_nestandardni_formati")
if pdf_dwg not in var_dwg:
    if not Path.is_dir(pateka_pdf_a4):
        Path.mkdir(pateka_pdf_a4)
        print("PDF_A4 folder was made!")
    else:
        pateka_pdf_a4.rename(Path(current_directory, "PDF_A4"))
    ...
    if not Path.is_dir(pateka_pdf_a3):
        ...
        pateka_pdf_a3.rename(Path(current_directory, "PDF_A3"))
    ...
    if not Path.is_dir(pateka_pdf_a2):
        ...
        pateka_pdf_a2.rename(Path(current_directory, "PDF_A2"))
    ...
    if not Path.is_dir(pateka_pdf_a1):
        ...
        pateka_pdf_a1.rename(Path(current_directory, "PDF_A1"))
    ...
    if not Path.is_dir(pateka_pdf_a0):
        ...
        pateka_pdf_a0.rename(Path(current_directory, "PDF_A0"))
    ...
    if not Path.is_dir(pateka_pdf_nestandarden_format):
        ...
        pateka_pdf_nestandarden_format.rename(Path(current_directory, "PDF_nestandardni_formati"))
